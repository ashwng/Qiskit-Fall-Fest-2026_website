        ...
        {registrationPerks.map((perk, i) => {
          ...
          return (
            <RevealOnScroll key={perk.id} delayMs={i * 70}>
              <div className="glass-dark group h-full rounded-2xl p-7 transition-all duration-300 hover:border-cyan/50 hover:shadow-[0_0_30px_rgba(8,189,186,0.1)] hover:-translate-y-1 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="mt-6 font-display text-lg font-bold text-ink transition-colors group-hover:text-cyan">
                    {perk.title}
                  </h3>
                ...
                <div className="mt-6 pt-4 border-t border-line-soft flex items-center justify-between font-mono text-[11px] text-muted">
                  <span className="uppercase tracking-widest text-violet-bright font-bold">100% Free</span>
                  <span className="text-cyan font-medium">Included</span>
                </div>
              </div>
            </RevealOnScroll>
          );
